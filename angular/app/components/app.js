...
var pdevx = angular.module('pdevx', [require('angular-animate'), require('angular-cookies'), require('angular-material'), require('angular-material-icons'), require('angular-messages'), require('angular-storage'), require('angular-translate'), require('angular-ui-router'), 'pdevx.main', 'pdevx.rps', 'templates', 'translations']);
...
pdevx.config(function ($stateProvider, $urlRouterProvider) {
    $stateProvider
        ...
        .state('app.rps', {
            ...
            views: {
                'mainContent': {
                    templateUrl: 'components/rps/rps.view.html',
                    controller: 'rpsController as vm'
                }
            }
        });

    // if none of the above states are matched, use this as the fallback
    $urlRouterProvider.otherwise('/rps');
});
