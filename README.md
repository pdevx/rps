...
- Bonus points for vanilla JavaScript, unit tests, good accessibility, responsive design, and well commented code
...
You are free to use any tools and frameworks that you prefer. Below are some suggestions:
